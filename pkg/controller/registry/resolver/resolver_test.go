...
func StartResolverInformers(namespace string, objs ...runtime.Object) externalversions.SharedInformerFactory {
	// Create client fakes
...
func TestNamespaceResolver_ResolveSteps(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			resolver:= NewNamespaceResolver("test", StartResolverInformers(namespace, test.in.clusterState...))

			resolver.ResolveSteps(nil)
		})
	}
}
