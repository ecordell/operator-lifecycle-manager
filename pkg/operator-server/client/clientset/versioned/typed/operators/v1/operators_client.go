...
import (
	...
	"github.com/operator-framework/operator-lifecycle-manager/pkg/operator-server/client/clientset/versioned/scheme"
...
func (c *OperatorsV1Client) Operators(namespace string) OperatorInterface {
