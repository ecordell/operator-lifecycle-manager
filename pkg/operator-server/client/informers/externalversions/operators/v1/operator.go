...
import (
	...
	versioned "github.com/operator-framework/operator-lifecycle-manager/pkg/operator-server/client/clientset/versioned"
	internalinterfaces "github.com/operator-framework/operator-lifecycle-manager/pkg/operator-server/client/informers/externalversions/internalinterfaces"
	v1 "github.com/operator-framework/operator-lifecycle-manager/pkg/operator-server/client/listers/operators/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.OperatorsV1().Operators(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OperatorsV1().Operators(namespace).Watch(options)
			},
		},
