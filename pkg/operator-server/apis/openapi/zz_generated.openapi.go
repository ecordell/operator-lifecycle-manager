...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/operator-framework/operator-lifecycle-manager/pkg/operator-server/apis/operators/v1.Operator":       schema_operator_server_apis_operators_v1_Operator(ref),
		"github.com/operator-framework/operator-lifecycle-manager/pkg/operator-server/apis/operators/v1.OperatorList":   schema_operator_server_apis_operators_v1_OperatorList(ref),
		"github.com/operator-framework/operator-lifecycle-manager/pkg/operator-server/apis/operators/v1.OperatorSpec":   schema_operator_server_apis_operators_v1_OperatorSpec(ref),
		"github.com/operator-framework/operator-lifecycle-manager/pkg/operator-server/apis/operators/v1.OperatorStatus": schema_operator_server_apis_operators_v1_OperatorStatus(ref),
...
func schema_operator_server_apis_operators_v1_Operator(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Operator holds information about a running operator that is watching the given namespace",
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/operator-framework/operator-lifecycle-manager/pkg/operator-server/apis/operators/v1.OperatorSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/operator-framework/operator-lifecycle-manager/pkg/operator-server/apis/operators/v1.OperatorStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/operator-framework/operator-lifecycle-manager/pkg/operator-server/apis/operators/v1.OperatorSpec", "github.com/operator-framework/operator-lifecycle-manager/pkg/operator-server/apis/operators/v1.OperatorStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_operator_server_apis_operators_v1_OperatorList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "OperatorList is a list of Operator objects.",
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
							Description: "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds",
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/operator-framework/operator-lifecycle-manager/pkg/operator-server/apis/operators/v1.Operator"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/operator-framework/operator-lifecycle-manager/pkg/operator-server/apis/operators/v1.Operator", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_operator_server_apis_operators_v1_OperatorSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Required: []string{"ClusterServiceVersionSpec"},
			},
		},
		Dependencies: []string{
			"github.com/operator-framework/operator-lifecycle-manager/pkg/api/apis/operators/v1alpha1.ClusterServiceVersionSpec"},
	}
}

func schema_operator_server_apis_operators_v1_OperatorStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "OperatorStatus represents the current status of the Operator",
				Properties: map[string]spec.Schema{
				...
				Required: []string{"ClusterServiceVersionStatus"},
			},
		},
		Dependencies: []string{
			"github.com/operator-framework/operator-lifecycle-manager/pkg/api/apis/operators/v1alpha1.ClusterServiceVersionStatus"},
	}
}
