...
// NewCommandStartOperatorServer provides a CLI handler for 'start master' command
// with a default OperatorServerOptions.
func NewCommandStartOperatorServer(defaults *OperatorServerOptions, stopCh <-chan struct{}) *cobra.Command {
	cmd := &cobra.Command{
	...
	flags.StringSliceVar(&defaults.WatchedNamespaces, "watched-namespaces", defaults.WatchedNamespaces, "list of namespaces the operator-server will watch watch for Operators")
...
func NewOperatorServerOptions(out, errOut io.Writer) *OperatorServerOptions {
	o := &OperatorServerOptions{
...
func (o *OperatorServerOptions) Complete() error {
	return nil
}

func (o *OperatorServerOptions) Config() (*apiserver.Config, error) {
...
func (o *OperatorServerOptions) Run(stopCh <-chan struct{}) error {
	if o.Debug {
