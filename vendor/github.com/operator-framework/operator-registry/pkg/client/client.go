...
type Interface interface {
	GetBundle(ctx context.Context, name string) (*registry.Bundle, error)
...
func (c *Client) GetBundle(ctx context.Context, name string) (*registry.Bundle, error) {
	bundle, err := c.client.GetBundle(ctx, &api.GetBundleRequest{CsvName:name})
	if err!=nil {
		return nil, err
	}
	return registry.NewBundleFromStrings(bundle.CsvName, bundle.Object)
}
