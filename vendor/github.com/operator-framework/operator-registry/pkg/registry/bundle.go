...
func NewBundle(name string, objs ...*unstructured.Unstructured) *Bundle {
	bundle := &Bundle{Name: name, cacheStale: false}
	for _, o := range objs {
		bundle.Add(o)
	}
	return bundle
...
func NewBundleFromStrings(name string, objs []string) (*Bundle, error) {
	...
	return NewBundle(name, unstObjs...), nil
}
